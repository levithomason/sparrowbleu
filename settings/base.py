...
# Include other apps
PROJECT_ROOT = abspath(os.path.curdir)
...
ROOT_URLCONF = 'sparrow_bleu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sparrow_bleu.wsgi.application'
...
INSTALLED_APPS = BASE_AND_LIBRARY_APPS + SPARROW_BLEU_APPS
