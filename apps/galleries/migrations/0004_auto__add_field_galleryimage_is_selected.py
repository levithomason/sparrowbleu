...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryImage.is_selected'
        db.add_column(u'galleries_galleryimage', 'is_selected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryImage.is_selected'
        db.delete_column(u'galleries_galleryimage', 'is_selected')
