...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryImage.name'
        db.add_column(u'galleries_galleryimage', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryImage.name'
        db.delete_column(u'galleries_galleryimage', 'name')
